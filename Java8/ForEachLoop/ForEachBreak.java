/*Program to print the sum of 10 numbers stored in an array using the for-each loop. The loop terminates if one of the elements is 7 and prints the obtained sum*/
