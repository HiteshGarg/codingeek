...
int main(void){
	...
	printf("\n%d\n", *p++);   
	/*only pointer will be incremented not the value and value printed will be of *p 
	 * without incremented address
	 * (*p) and then p++
	 * */	
	 ...
	 * content of p is read then increment done and then dereferenced i.e. access the value
	 *++p and then *p
	 * */
