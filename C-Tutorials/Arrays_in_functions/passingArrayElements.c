...
int main()
{
    ...
    for(i=0 ;i<5 ;i++)
    {
        display(num[i]);//a single element is being sent to the function to get displayed
    }
    return 0;
}
void display(int x)//formal parameter takes a single variable and not a whole array
{
