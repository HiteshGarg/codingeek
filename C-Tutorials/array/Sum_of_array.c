...
int main()
{
    ...
    for(i=0;i<5;i++)//user inputs the numbers in the second array
        scanf("%d",&b[i]);
    for(i=0;i<5;i++)//accesses the data elements of the first two arrays, adds them and stores them in the third array
        c[i]=a[i]+b[i];
