...
int main() {
  int a = 5, *b, **c; /* *b used in declaration  of a pointer. It gives the
  value at the address stored in b. **c is used for the declaration of another
  pointer. It points to the address of variable 'b' */
